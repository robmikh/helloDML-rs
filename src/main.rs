...
use windows::{
    ...
    Win32::{
        ...
        AI::MachineLearning::DirectML::{
            ...
            DML_OPERATOR_ELEMENT_WISE_IDENTITY, DML_TENSOR_DATA_TYPE_FLOAT32, DML_TENSOR_DESC,
            DML_TENSOR_FLAG_NONE, DML_TENSOR_TYPE_BUFFER,
        },
    },
};

use crate::{
    d3dx12::{update_subresource_heap, D3DX12ResourceBarrier},
    dml::dml_calc_buffer_tensor_size,
};
